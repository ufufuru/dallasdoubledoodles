                    ...
                    <Col>
                        <div className="AboutUs">
                            <p>
                                ...
                                from 50-70 pounds. A golden-doodle is a cross between a poodle and gold retriever. Poodles remain the
                                second smartest dog in the purebred world along with being very loyal and protective, while Labrador
                                and Golden Retrievers remain the most popular pure bred dogs because their intelligence, athleticism,
                                and being family friendly dogs. With double doodles, you get double the love and fun along with being
                                allergy friendly with low to non-shedding coats along with low to no odor pet dander. They are also
